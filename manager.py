...
def banner():
   ...
   'JV.Bots / SIMPLE ADDER / Criado por JV TRADER',

    ]
    for char in b:
        print(f'{random.choice(colors)}{char}{n}')
    print(f'{r}   {r}')
    print(f'{r} Channel: @JVTRADER6595{r}')
    print(f'{cy} Group : @digitaljvbots{cy}')
    print(f'{r}   {r}')
...
while True:
    ...
    if a == 1:
        ...
        webbrowser.open('https://www.youtube.com/channel/UCuK62MxQZFulRALHMq6hS9w')
        clr()
        banner()
        exit()
